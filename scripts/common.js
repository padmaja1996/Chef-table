...
function footerTemplate() {
    let footertemplate = '<span class="address">' +
        '497 Evergreen Rd. Roseville, CA 95673, Pune' +
        '<br />' +
        '+91 7767061328' +
        '<br />' +
        'gadyanavarpadmaja@mail.com' +
    '</span>' +
    '<div class="social-media-icons-container">' +
        '<a href="https://www.facebook.com/" target="_blank"><img src="assets/images/logo-facebook.png" class="social-media-icons"/></a>' +
        '<a href="https://www.instagram.com/" target="_blank"><img src="assets/images/logo-instagram.png" class="social-media-icons" /></a>' +
        '<a href="https://twitter.com/" target="_blank"><img src="assets/images/logo-twitter.png" class="social-media-icons" /></a>' +
    '</div>' +
